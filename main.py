...
def attack(char_name: str, char_class: str) -> str:
    """
    This function count the damage
    that a certain character class
...
def defence(char_name: str, char_class: str) -> str:
    """
    Calculates how much a certain
    character class blocks damage.
    """
    if char_class == 'warrior':
        return (f'{char_name}'
...
def special(char_name: str, char_class: str) -> str:
    """
    Shows which special skill a
    certain character class has applied.
    """
    if char_class == 'warrior':
        return (f'{char_name}'
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Informs about the features of a
    certain character class and shows
    his attack, defense and special skills.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    and gives information about him.
    """
    approve_choice: str = ''
    char_class: str = ''
